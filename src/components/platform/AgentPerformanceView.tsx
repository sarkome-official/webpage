...
const AgentCard = ({ agent }: { agent: Agent }) => {
    ...
    return (
        <div className={`bg-[#1c1d27] rounded-xl p-6 flex flex-col gap-6 relative overflow-hidden transition-all duration-500 border ${style.glow} min-h-[200px]`}>
            ...
            <div className="bg-[#111218] p-4 rounded-lg font-mono text-sm text-[#9da1b9] h-32 overflow-hidden relative z-10 flex flex-col justify-end gap-2 border border-[#282b39]">
                ...
                <div className="truncate transition-all duration-300 text-white">
            ...
            <main className="flex-1 p-4 md:p-6 lg:p-10 max-w-[1600px] w-full mx-auto flex flex-col gap-6 md:gap-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-[#1c1d27] border border-[#282b39] p-5 rounded-xl">
                        ...
                        <p className="text-xs text-[#9da1b9]">GPT-5.1-Codex-Max Active</p>
                    </div>
                    <div className="bg-[#1c1d27] border border-[#282b39] p-5 rounded-xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-96">
                    ...
                    <div className="bg-[#1c1d27] border border-[#282b39] rounded-xl overflow-hidden flex flex-col">
                        <div className="px-4 py-3 bg-[#111218] border-b border-[#282b39]">
                            <h3 className="text-sm font-bold text-white uppercase tracking-wider">Live Chain of Thought</h3>
                        </div>
                        <div className="flex-1 overflow-y-auto p-4 space-y-3 font-mono text-xs">
                            <div className="flex gap-2 text-[#9da1b9]">
                                <span className="text-[#6b7280]">10:44:12</span>
                                <span className="text-blue-400">[Sarkome]</span>
