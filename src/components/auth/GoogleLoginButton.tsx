...
export function GoogleLoginButton({ className }: { className?: string }) {
    ...
    return (
        <a
            className={cn(
                "inline-flex items-center gap-3 bg-white text-[#1a73e8] px-6 py-2.5 rounded-full text-sm font-medium hover:bg-gray-50 transition-all shadow-md hover:shadow-lg cursor-pointer",
                isLoading && "opacity-70 cursor-not-allowed",
                className
            )}
        ...
        >
            ...
            <span className="font-google font-medium">
