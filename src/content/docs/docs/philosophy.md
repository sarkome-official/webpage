...
The system continuously monitors which knowledge nodes are being accessed by the Agent Council:
...
The Virtual Mind doesn't just remember—it **discovers**. The Agent Council uses the graph not as a lookup table but as a *reasoning substrate*:
